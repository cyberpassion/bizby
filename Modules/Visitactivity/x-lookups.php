...
return [
    ...
    'visitactivity.default-columns' => [
        'entry' => [
            'visitactivity_id','visit_date','visit_by_name',
    ...
    'visitactivity.list-filters-simple' => [
        'visit_date',
        'visit_by',
        'company_name',
        'visit_status',
    ...
    'mandatoryOptionsBeforeUsing-visitactivity' => [
        'missing_option' => [
            'Email IDs to send VAR Email (Mandatorily)' =>
                'visitactivity_default_email_recipient',
        ],
    ],
