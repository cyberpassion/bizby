...
namespace Modules\Visitactivity\Providers;
...
class VisitactivityServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Visitactivity';

    protected string $nameLower = 'visitactivity';
