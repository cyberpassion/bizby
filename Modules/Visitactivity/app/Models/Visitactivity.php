...
namespace Modules\Visitactivity\Models;
...
class Visitactivity extends Model
{
    ...
    protected $table = 'cyp_visitactivity';

	// Specify custom primary key
	protected $primaryKey = 'visitactivity_id';
    ...
    // protected static function newFactory(): VisitactivityFactory
    // {
    //     return VisitactivityFactory::new();
    // }
