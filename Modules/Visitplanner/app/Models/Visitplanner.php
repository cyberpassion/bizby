...
class Visitplanner extends Model
{
    ...
    protected $table = 'cyp_visitplanner';

	// Specify custom primary key
	protected $primaryKey = 'visitplanner_id';
    ...
    protected $casts = [
		'datetime'			=> 'datetime',
        'visitplanner_date' => 'date', // Laravel will cast it to Carbon
    ];
    ...
    // protected static function newFactory(): VisitplannerFactory
    // {
    //     return VisitplannerFactory::new();
    // }
