...
namespace Modules\Visitplanner\Providers;
...
class VisitplannerServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Visitplanner';

    protected string $nameLower = 'visitplanner';
