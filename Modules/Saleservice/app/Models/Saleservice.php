...
class Saleservice extends Model
{
    ...
    protected $table = 'cyp_saleservice';

	// Specify custom primary key
	protected $primaryKey = 'saleservice_id';
    ...
    protected $casts = [
		'datetime'			=> 'datetime',
        'saleservice_date' => 'date', // Laravel will cast it to Carbon
    ];
    ...
    // protected static function newFactory(): SaleserviceFactory
    // {
