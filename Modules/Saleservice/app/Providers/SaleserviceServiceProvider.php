...
namespace Modules\Saleservice\Providers;
...
class SaleserviceServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Saleservice';

    protected string $nameLower = 'saleservice';
