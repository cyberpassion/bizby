...
namespace Modules\Meetingmanager\Providers;
...
class MeetingmanagerServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Meetingmanager';

    protected string $nameLower = 'meetingmanager';
