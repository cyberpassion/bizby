...
namespace Modules\Meetingmanager\Models;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Support\Facades\Schema;

class Meetingmanager extends Model
{
    use HasFactory;
    ...
    protected $table = 'cyp_meetingmanager';

	// Specify custom primary key
	protected $primaryKey = 'meetingmanager_id';
    ...
    protected $casts = [
		'datetime'			=> 'datetime',
        'meetingmanager_date' => 'date', // Laravel will cast it to Carbon
    ];
    ...
    // protected static function newFactory(): MeetingmanagerFactory
    // {
    //     return MeetingmanagerFactory::new();
    // }
